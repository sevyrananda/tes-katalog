...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Katalog Barang /</span> Printer & Scanner</h4>
    <hr class="my-2" />
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center px-3 pb-2">
            <h5 class="card-header mb-0">Data Printer & Scanner</h5>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahPrinter">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td>
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#detailModal{{ $printer->id }}">
                                    <i class="bx bx-show me-2"></i> Detail
                                </button>
                                <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editModal{{ $printer->id }}">
                                    <i class="bx bx-edit-alt me-2"></i> Edit
                                </button>
                                <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $printer->id }}')">
...
<script>
    function confirmDelete(id) {
        ...
        form.action = '/katalog/printers/' + id;
...
@include('pages.printer.modal.add')
@include('pages.printer.modal.edit')
@include('pages.printer.modal.del')
@include('pages.printer.modal.detail')
