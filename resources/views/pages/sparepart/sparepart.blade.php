...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Katalog Barang /</span> Sparepart</h4>
    <hr class="my-2" />
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center px-3 pb-2">
            <h5 class="card-header mb-0">Data Sparepart</h5>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahSparepart">
...
<script>
    function confirmDelete(id) {
        ...
        form.action = '/katalog/spareparts/' + id;
