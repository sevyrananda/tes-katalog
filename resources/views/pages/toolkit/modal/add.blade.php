<!-- Modal Tambah Toolkit -->
<div class="modal fade" id="modalTambahToolkit" tabindex="-1" aria-labelledby="modalTambahToolkitLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahToolkitLabel">Tambah Toolkit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahToolkit" action="{{ route('toolkits.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
