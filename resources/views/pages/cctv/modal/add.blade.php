<!-- Modal Tambah Cctv -->
<div class="modal fade" id="modalTambahCctv" tabindex="-1" aria-labelledby="modalTambahCctvLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahCctvLabel">Tambah Cctv</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahCctv" action="{{ route('cctv.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
