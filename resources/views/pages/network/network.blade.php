...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Katalog Barang /</span> Network</h4>
    <hr class="my-2" />
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center px-3 pb-2">
            <h5 class="card-header mb-0">Data Network</h5>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahNetwork">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody>
                    @forelse($networks as $index => $network)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td>
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#detailModal{{ $network->id }}">
                                ...
                                <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $network->id }}')">
...
<script>
    function confirmDelete(id) {
        ...
        form.action = '/katalog/networks/' + id;
...
@include('pages.network.modal.add')
@include('pages.network.modal.edit')
@include('pages.network.modal.del')
@include('pages.network.modal.detail')
