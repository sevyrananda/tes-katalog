<!-- Modal Tambah Network -->
<div class="modal fade" id="modalTambahNetwork" tabindex="-1" aria-labelledby="modalTambahNetworkLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahNetworkLabel">Tambah Network</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahNetwork" action="{{ route('network.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
