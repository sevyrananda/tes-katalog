...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Katalog Barang /</span> Locotrack</h4>
    <hr class="my-2" />
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center px-3 pb-2">
            <h5 class="card-header mb-0">Data Locotrack</h5>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahLocotrack">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody>
                    @forelse($locotracks as $index => $locotrack)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td>
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#detailModal{{ $locotrack->id }}">
                                    <i class="bx bx-show me-2"></i> Detail
                                </button>
                                <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editModal{{ $locotrack->id }}">
                                    <i class="bx bx-edit-alt me-2"></i> Edit
                                </button>
                                <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $locotrack->id }}')">
...
<script>
    function confirmDelete(id) {
        ...
        form.action = '/katalog/locotracks/' + id;
...
@include('pages.locotrack.modal.add')
@include('pages.locotrack.modal.edit')
@include('pages.locotrack.modal.del')
@include('pages.locotrack.modal.detail')
