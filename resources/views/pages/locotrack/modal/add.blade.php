<!-- Modal Tambah Locotrack -->
<div class="modal fade" id="modalTambahLocotrack" tabindex="-1" aria-labelledby="modalTambahLocotrackLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahLocotrackLabel">Tambah Locotrack</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahLocotrack" action="{{ route('locotrack.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
