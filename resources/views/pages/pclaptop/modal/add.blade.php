<!-- Modal Tambah Pclaptop -->
<div class="modal fade" id="modalTambahPclaptop" tabindex="-1" aria-labelledby="modalTambahPclaptopLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahPclaptopLabel">Tambah PC & Laptop</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahPclaptop" action="{{ route('pclaptop.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
