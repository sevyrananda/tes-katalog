@foreach($pclaptops as $pclaptop)
    <!-- Modal Detail -->
    <div class="modal fade" id="detailModal{{ $pclaptop->id }}" tabindex="-1"
        aria-labelledby="detailModalLabel{{ $pclaptop->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailModalLabel{{ $pclaptop->id }}">Detail PC & Laptop</h5>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($pclaptop->link_ref)
                                    <a href="{{ $pclaptop->link_ref }}" target="_blank" class="text-blue-500 underline">Lihat</a>
                                @else
