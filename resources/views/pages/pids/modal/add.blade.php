<!-- Modal Tambah Pids -->
<div class="modal fade" id="modalTambahPids" tabindex="-1" aria-labelledby="modalTambahPidsLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahPidsLabel">Tambah PIDS</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahPids" action="{{ route('pids.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
