@foreach($pidss as $pids)
    <!-- Modal Detail -->
    <div class="modal fade" id="detailModal{{ $pids->id }}" tabindex="-1"
        aria-labelledby="detailModalLabel{{ $pids->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailModalLabel{{ $pids->id }}">Detail PIDS</h5>
