<!-- Modal Tambah Ups -->
<div class="modal fade" id="modalTambahUps" tabindex="-1" aria-labelledby="modalTambahUpsLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahUpsLabel">Tambah UPS & Baterai</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahUps" action="{{ route('ups.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
