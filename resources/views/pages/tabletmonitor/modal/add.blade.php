<!-- Modal Tambah Tabletmonitor -->
<div class="modal fade" id="modalTambahTabletmonitor" tabindex="-1" aria-labelledby="modalTambahTabletmonitorLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahTabletmonitorLabel">Tambah Tablet & Monitor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <hr>
            <div class="modal-body">
                <form id="formTambahTabletmonitor" action="{{ route('tabletmonitor.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="mb-3">
